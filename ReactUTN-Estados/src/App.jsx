...
const App = () => {
  ...
  const validarPassword = () => palabrasProhibidas.some((palabra) => == password)
  ...
  return (
    ...
    <>
      ...
      <div>
        <form>
          <input placeholder='Escriba un mensaje' value={mensaje} onChange={(event) => actualizarInput(event.target.value)}></input>
